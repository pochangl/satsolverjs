...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c9 = function(left, operator, right) {
        	return {
            name: operator,
            clauses: [left, right]
          }
  ...
  function peg$parseExpression() {
    ...
    s1 = peg$parse_();
    if (s1 !== peg$FAILED) {
      s2 = peg$parseClauseChainOperator();
      if (s2 === peg$FAILED) {
        s2 = peg$parseClause();
      }
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseClauseChainOperator() {
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (s2 !== peg$FAILED) {
        ...
        if (s3 !== peg$FAILED) {
          s4 = peg$parsespace();
          if (s4 !== peg$FAILED) {
            s5 = peg$parseClauseChainOperator();
            if (s5 === peg$FAILED) {
              s5 = peg$parseClause();
            }
            if (s5 !== peg$FAILED) {
  ...
  function peg$parseClause() {
    ...
    s0 = peg$currPos;
    s1 = peg$parseSubclause();
    if (s1 === peg$FAILED) {
      s1 = peg$parseChainOperator();
      if (s1 === peg$FAILED) {
        s1 = peg$parseBindOperator();
        if (s1 === peg$FAILED) {
          s1 = peg$parsePrefix();
          if (s1 === peg$FAILED) {
            s1 = peg$parseAtomic();
